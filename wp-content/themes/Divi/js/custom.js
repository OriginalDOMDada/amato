(function($){
	...
	$('.home .et_pb_post_slider_0').append('<img style="height: 40px; width: 40px; position: absolute; top: 15px; left: 15px; " src="/wp-content/uploads/icons/icons-02.svg"/>');
	$('.home .et_pb_post_slider_1').append('<img style="height: 40px; width: 40px; position: absolute; top: 15px; left: 15px; " src="/wp-content/uploads/icons/icons-01.svg"/>');
	$('.home .et_pb_post_slider_2').append('<img style="height: 40px; width: 40px; position: absolute; top: 15px; left: 15px; " src="/wp-content/uploads/icons/icons-03.svg"/>');
	$('.home .et_pb_post_slider_3').append('<img style="height: 40px; width: 40px; position: absolute; top: 15px; left: 15px; " src="/wp-content/uploads/icons/icons-04.svg"/>');
	$('.home .et_pb_post_slider_4').append('<img style="height: 40px; width: 40px; position: absolute; top: 15px; left: 15px; " src="/wp-content/uploads/icons/icons-05.svg"/>');
	$('.home .et_pb_post_slider_5').append('<img style="height: 40px; width: 40px; position: absolute; top: 15px; left: 15px; " src="/wp-content/uploads/icons/icons-06.svg"/>');

	$('.home .et_pb_slider').each( function(){
		var link = $(this).find('.et_pb_more_button').attr('href');
		$(this).wrap("<a href='" + link + "'></a> ");
		$(this).find('.et_pb_more_button').remove();
	});
